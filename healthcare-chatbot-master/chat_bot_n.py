...
training = pd.read_csv('C:\GitHUB-Backup\core-python-samples1\CapStone\healthcare-chatbot-master\Data\Training.csv')
testing= pd.read_csv('C:\GitHUB-Backup\core-python-samples1\CapStone\healthcare-chatbot-master\Data\Testing.csv')
...
def getDescription():
    ...
    with open('C:\\test\healthcare-chatbot-master\MasterData\symptom_Description.csv') as csv_file:
...
def getSeverityDict():
    ...
    with open('C:\\test\healthcare-chatbot-master\MasterData\symptom_severity.csv') as csv_file:
...
def getprecautionDict():
    ...
    with open('C:\\test\healthcare-chatbot-master\MasterData\symptom_precaution.csv') as csv_file:
...
def sec_predict(symptoms_exp):
    df = pd.read_csv('C:\\test\healthcare-chatbot-master\Data\Training.csv')
    X = df.iloc[:, :-1]
    y = df['prognosis']
